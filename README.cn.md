...
[![x-cmd/install — protobuf Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/protobuf.svg?lang=zh)](https://x-cmd.com/install/protobuf)
...
合计: **1,078,825** 行代码（覆盖前 5 种语言、共 **1805** 个文件）。
...
- **Star**: 72,062 · **Fork**: 16,291 · **开放 issue**: 6,935 · **贡献者**: 1,238

## 累计统计

- **发布数**: 221 · **已合并 PR**: 9950 · **开放 PR**: 338 · **已关闭 issue**: 6794 · **开放 issue**: 141 · **提交数**: 24101
...
_数据快照: `data/card/260924.yml` · 2026-09-24T05:35:54Z._
